...
public class AutodealerTestContainer extends TestContainer {

    public AutodealerTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/galua/autodealer/app.properties",
    ...
    public static class Common extends AutodealerTestContainer {

        public static final AutodealerTestContainer.Common INSTANCE = new AutodealerTestContainer.Common();
